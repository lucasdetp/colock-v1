...
import RythmePreferenceTemplate from '../templates/RythmePreferenceTemplate';
...
const identityData = [
  {
    ...
    `,
    title: 'Niveau rythme, tu es plutôt...',
  }
];

const RythmePreferenceScreen = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        {identityData.map((item, index) => (
          <RythmePreferenceTemplate 
            key={index}
...
export default RythmePreferenceScreen;
